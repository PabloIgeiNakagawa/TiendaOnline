...
namespace TiendaOnline.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260404011916_agregar_fecha_en_preparacion_pedido")]
    partial class agregar_fecha_en_preparacion_pedido
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TiendaOnline.Domain.Entities.AppSetting", b =>
                {
            ...
            modelBuilder.Entity("TiendaOnline.Domain.Entities.MetodoDePago", b =>
                {
            ...
            modelBuilder.Entity("TiendaOnline.Domain.Entities.Pedido", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaEnPreparacion")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("TransaccionPagoId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("TiendaOnline.Domain.Entities.Pedido", b =>
                {
                    b.HasOne("TiendaOnline.Domain.Entities.MetodoDePago", "MetodoDePago")
                        .WithMany()
